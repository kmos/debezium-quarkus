...
public class SqlServerEngineProducer implements ConnectorProducer {
    ...
    @Inject
    public SqlServerEngineProducer(AgroalParser agroalParser, DebeziumFactory debeziumFactory) {
    ...
    public DebeziumConnectorRegistry engine(DebeziumEngineConfigurationHandler debeziumEngineConfigurationHandler) {
        List<MultiEngineConfiguration> multiEngineConfigurations = agroalParser.parse(debeziumEngineConfigurationHandler.get(), DatabaseKind.MSSQL, SQLSERVER);
