...
/**
 *
 * Test Suite Debezium Quarkus Extension for Sql datasource
 * <p>
 * Test Suite Scenario expectations:
 *  - one source of data called `inventory`
 *  - three table: general, products, orders {@link Order} and users {@link User}
 *  - expected data:
 *      - users:
 *          | id | name | description |
 ...
 */
@Suite
@SelectClasses({ DebeziumServerTest.class })
