...
CREATE USER native IDENTIFIED BY dbz;

GRANT CONNECT TO native;
GRANT CREATE SESSION TO native;
GRANT CREATE TABLE TO native;
GRANT CREATE SEQUENCE TO native;

ALTER USER native QUOTA UNLIMITED ON SYSTEM;