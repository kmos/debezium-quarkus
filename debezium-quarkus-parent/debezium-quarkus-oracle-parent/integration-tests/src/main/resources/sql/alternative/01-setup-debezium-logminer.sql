...
CREATE USER alternative IDENTIFIED BY dbz;

GRANT CONNECT TO alternative;
GRANT CREATE SESSION TO alternative;
GRANT CREATE TABLE TO alternative;
GRANT CREATE SEQUENCE TO alternative;

ALTER USER alternative QUOTA UNLIMITED ON SYSTEM;