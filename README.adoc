...
[width="50%"]
|===
|main | image:https://github.com/debezium/debezium-quarkus/actions/workflows/ci-build.yaml/badge.svg?branch=main["Main Branch Build", link="https://github.com/apache/camel-quarkus/actions?query=workflow%3A%Debezium+Quarkus+CI%22"]
|===
